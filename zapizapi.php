...
if ( ! function_exists( 'add_filter' ) ) { // Protege contra acesso direto verificando se qualquer função nativa do wordpres foi definida anteriormente
                                           // Protects direct file access verifying if some wp native function is defined 
